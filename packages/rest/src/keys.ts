...
import {HttpProtocol, HttpServerFactory} from '@loopback/http-server';
...
export namespace RestBindings {
   ...
   */
  export const HTTP_SERVER_FACTORY = BindingKey.create<HttpServerFactory>(
    'rest.httpServerFactory',
  );
